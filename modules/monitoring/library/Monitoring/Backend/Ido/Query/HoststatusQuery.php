    ...
    protected $columnMap = array(
        ...
        'hoststatus' => array(
            ...
            ELSE
                ...
                +
                CASE 
                WHEN hs.problem_has_been_acknowledged = 1
                    THEN 8
                WHEN hs.scheduled_downtime_depth > 0
                    THEN 4
                WHEN (NOT hs.problem_has_been_acknowledged = 1) AND (NOT hs.scheduled_downtime_depth > 0)
                    THEN 128
                END
            END',
